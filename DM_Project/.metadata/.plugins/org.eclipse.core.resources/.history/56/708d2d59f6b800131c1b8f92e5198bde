...
//		this.cleanStringValues(pattern, 3);
		...
		data = this.cleanStringValues(7, normalizationPatterns);
		...
		data = this.cleanStringValues(8, normalizationPatterns);
...
//		data = this.cleanStringValues(pattern, 11);
		...
		System.out.println("---------------------------------");
		pattern = "^(Yes|No).?$";
		data = this.cleanStringValues(14, normalizationPatterns);
		...
		data = this.cleanStringValues(15, normalizationPatterns);
		...
		data = this.cleanStringValues(16, normalizationPatterns);
...
//		this.cleanStringValues(pattern, 17);
		...
		data = this.cleanStringValues(18, normalizationPatterns);
