...
public class InformationGain implements Comparator<InformationGain>, Comparable<InformationGain>{
	...
	public InformationGain(ArrayList<ID3Object> objects, Object classifierAttribute, Object attribute) throws Exception {
		super();
	 ...
	 * @throws Exception 
	 */
	public double gain(ArrayList<ID3Object> objects, Object classifierAttribute, Object attribute) throws Exception{
	 ...
	 * @throws Exception 
	 */
	private double info(ArrayList<ID3Object> objects, Object classifierAttribute) throws Exception{
	 ...
	 * @throws Exception 
	 */
	private double info_A(ArrayList<ID3Object> objects, Object classifierAttribute, Object attribute) throws Exception{	
